...
// enough that all such attempts are guarded in a ***REMOVED*** block.
"use strict";
...
***REMOVED*** : function( array ) ***REMOVED***
	return arr.concat.***REMOVED***ly( [], array );
***REMOVED***;
	...
	***REMOVED***;
	...
	function DOMEval( code, node, doc ) ***REMOVED***
		...
		if ( node ) ***REMOVED***
			...
			***REMOVED***
		***REMOVED***
		doc.head.***REMOVED***endChild( script ).parentNode.removeChild( script );
	***REMOVED***
...
jQuery.fn = jQuery.prototype = ***REMOVED***
	...
	***REMOVED***,
	...
	slice: function() ***REMOVED***
		return this.pushStack( slice.***REMOVED***ly( this, arguments ) );
	***REMOVED***,
...
jQuery.extend( ***REMOVED***
	...
	***REMOVED***,
	...
	// push.***REMOVED***ly(_, arraylike) throws on ancient WebKit
...
var i,
	...
	***REMOVED***,
	...
	// Used for iframes
	// See setDocument()
	// Removing the function wr***REMOVED***er causes a "Permission Denied"
	// error in IE
...
// Optimize for push.***REMOVED***ly( _, NodeList )
***REMOVED*** ***REMOVED***
	push.***REMOVED***ly(
	...
	// Support: Android<4.0
	// Detect silently failing push.***REMOVED***ly
	// eslint-disable-next-line no-unused-expressions
	arr[ preferredDoc.childNodes.length ].nodeType;
***REMOVED*** catch ( e ) ***REMOVED***
	push = ***REMOVED*** ***REMOVED***ly: arr.length ?

		// Leverage slice if possible
		function( target, els ) ***REMOVED***
			pushNative.***REMOVED***ly( target, slice.call( els ) );
		***REMOVED*** :

		// Support: IE<9
		// Otherwise ***REMOVED***end directly
		function( target, els ) ***REMOVED***
			var j = target.length,
				i = 0;
	...
	***REMOVED***
	...
	if ( !seed ) ***REMOVED***
		...
		if ( documentIsHTML ) ***REMOVED***
			...
			// If the selector is sufficiently simple, ***REMOVED*** using a "get*By*" DOM method
			...
			if ( nodeType !== 11 && ( match = rquickExpr.exec( selector ) ) ) ***REMOVED***
				...
				***REMOVED*** else if ( match[ 2 ] ) ***REMOVED***
					push.***REMOVED***ly( results, context.getElementsByTagName( selector ) );
					return results;
				...
				***REMOVED*** else if ( ( m = match[ 3 ] ) && support.getElementsByClassName &&
					...
					push.***REMOVED***ly( results, context.getElementsByClassName( m ) );
					return results;
				***REMOVED***
			***REMOVED***
 ...
 *	deleting the oldest en***REMOVED***
 */
 ...
 * @param ***REMOVED***Function***REMOVED*** handler The method that will be ***REMOVED***lied
 */
...
setDocument = Sizzle.setDocument = function( node ) ***REMOVED***
	...
	***REMOVED***
	...
	support.scope = assert( function( el ) ***REMOVED***
		docElem.***REMOVED***endChild( el ).***REMOVED***endChild( document.createElement( "div" ) );
	...
	***REMOVED*** );
	...
	support.getElementsByTagName = assert( function( el ) ***REMOVED***
		el.***REMOVED***endChild( document.createComment( "" ) );
	...
	***REMOVED*** );
	...
	support.getById = assert( function( el ) ***REMOVED***
		docElem.***REMOVED***endChild( el ).id = expando;
		...
		***REMOVED*** :
		...
		function( tag, context ) ***REMOVED***
			var elem,
				...
				// By h***REMOVED***y coincidence, a (broken) gEBTN ***REMOVED***ears on DocumentFragment nodes too
	...
	***REMOVED***;
	...
	if ( ( support.qsa = rnative.test( document.querySelectorAll ) ) ) ***REMOVED***
		...
		assert( function( el ) ***REMOVED***
			...
			docElem.***REMOVED***endChild( el ).innerHTML = "<a id='" + expando + "'></a>" +
		...
		***REMOVED*** );
		...
		assert( function( el ) ***REMOVED***
			...
			el.***REMOVED***endChild( input ).setAttribute( "name", "D" );
			...
			***REMOVED***
			...
			docElem.***REMOVED***endChild( el ).disabled = true;
	...
	pseudos: ***REMOVED***
		...
		***REMOVED***,
		...
		"empty": function( elem ) ***REMOVED***
			...
			// nodeType < 6 works because attributes (2) do not ***REMOVED***ear as children
			for ( elem = elem.firstChild; elem; elem = elem.nextSibling ) ***REMOVED***
		...
		***REMOVED***,
		...
		"text": function( elem ) ***REMOVED***
			...
			return elem.nodeName.toLowerCase() === "input" &&
				...
				// Support: IE<8
				// New HTML5 attribute values (e.g., "search") ***REMOVED***ear with elem.type === "text"
	...
	***REMOVED***
	return markFunction( function( seed, results, context, xml ) ***REMOVED***
		...
		***REMOVED*** else ***REMOVED***
			...
			***REMOVED*** else ***REMOVED***
				push.***REMOVED***ly( results, matcherOut );
			***REMOVED***
		***REMOVED***
	***REMOVED*** );
***REMOVED***
...
function matcherFromTokens( tokens ) ***REMOVED***
	...
	for ( ; i < len; i++ ) ***REMOVED***
		...
		***REMOVED*** else ***REMOVED***
			matcher = Expr.filter[ tokens[ i ].type ].***REMOVED***ly( null, tokens[ i ].matches );
			...
			***REMOVED***
			...
			if ( bySet && i !== matchedCount ) ***REMOVED***
				...
				***REMOVED***
				...
				push.***REMOVED***ly( results, setMatched );
...
select = Sizzle.select = function( selector, context, results, seed ) ***REMOVED***
	...
	if ( match.length === 1 ) ***REMOVED***
		...
		if ( tokens.length > 2 && ( token = tokens[ 0 ] ).type === "ID" &&
			...
			// Precompiled matchers will still verify ances***REMOVED***, so step up a level
		...
		fire = function() ***REMOVED***
			...
			for ( ; queue.length; firingIndex = -1 ) ***REMOVED***
				...
				while ( ++firingIndex < list.length ) ***REMOVED***
					...
					if ( list[ firingIndex ].***REMOVED***ly( memory[ 0 ], memory[ 1 ] ) === false &&
...
function adoptValue( value, resolve, reject, noValue ) ***REMOVED***
	...
	***REMOVED*** ***REMOVED***
		...
		***REMOVED*** else ***REMOVED***
			...
			resolve.***REMOVED***ly( undefined, [ value ].slice( noValue ) );
		***REMOVED***

	// For Promises/A+, convert exceptions into rejections
	// Since jQuery.when doesn't unwrap thenables, we can skip the extra checks ***REMOVED***earing in
	// Deferred#then to conditionally suppress rejection.
	***REMOVED*** catch ( value ) ***REMOVED***

		// Support: Android 4.0 only
		// Strict mode functions invoked without .call/.***REMOVED***ly get global-object context
		reject.***REMOVED***ly( undefined, [ value ] );
	***REMOVED***
***REMOVED***
					...
					return jQuery.Deferred( function( newDefer ) ***REMOVED***
						jQuery.each( tuples, function( _i, tuple ) ***REMOVED***
							...
							deferred[ tuple[ 1 ] ]( function() ***REMOVED***
								var returned = fn && fn.***REMOVED***ly( this, arguments );
							...
							var that = this,
								...
								mightThrow = function() ***REMOVED***
									...
									***REMOVED***
									...
									returned = handler.***REMOVED***ly( that, args );
...
jQuery.Deferred.exceptionHook = function( error, stack ) ***REMOVED***
	...
	// Support: IE 8 - 9 only
	// Console exists when dev tools are open, which can h***REMOVED***en at any time
...
jQuery.fn.ready = function( fn ) ***REMOVED***
	...
	readyList
		...
		// h***REMOVED***ens at the time of error handling instead of callback
		// registration.
	...
	***REMOVED***,
	access: function( owner, key, value ) ***REMOVED***
		...
		***REMOVED***
		...
		// Since the "set" path can have two possible en***REMOVED*** points
...
function dataAttr( elem, key, data ) ***REMOVED***
	...
	// If nothing was found internally, ***REMOVED*** to fetch any
	...
	data: function( key, value ) ***REMOVED***
		...
		***REMOVED***
		...
		return access( this, function( value ) ***REMOVED***
			...
			// (and therefore has an element ***REMOVED***ears at this[ 0 ]) and the
...
function adjustCSS( elem, prop, valueParts, tween ) ***REMOVED***
	...
	if ( initialInUnit && initialInUnit[ 3 ] !== unit ) ***REMOVED***
		...
		// Iteratively ***REMOVED***roximate from a nonzero starting point
...
function getDefaultDisplay( elem ) ***REMOVED***
	...
	***REMOVED***
	...
	temp = doc.body.***REMOVED***endChild( doc.createElement( nodeName ) );
...
( function() ***REMOVED***
	var fragment = document.createDocumentFragment(),
		div = fragment.***REMOVED***endChild( document.createElement( "div" ) ),
		input = document.createElement( "input" );
...
function buildFragment( elems, context, scripts, selection, ignored ) ***REMOVED***
	...
	for ( ; i < l; i++ ) ***REMOVED***
		...
		if ( elem || elem === 0 ) ***REMOVED***
			...
			***REMOVED*** else ***REMOVED***
				tmp = tmp || fragment.***REMOVED***endChild( context.createElement( "div" ) );
				...
				// Descend through wr***REMOVED***ers to the right content
				j = wrap[ 0 ];
				while ( j-- ) ***REMOVED***
					tmp = tmp.lastChild;
				***REMOVED***
	...
	***REMOVED***
	...
	// Remove wr***REMOVED***er from fragment
	...
	while ( ( elem = nodes[ i++ ] ) ) ***REMOVED***
		...
		***REMOVED***
		...
		// Append to fragment
		tmp = getAll( fragment.***REMOVED***endChild( elem ), "script" );
	...
	***REMOVED***
	...
	if ( one === 1 ) ***REMOVED***
		...
		fn = function( event ) ***REMOVED***
			...
			jQuery().off( event );
			return origFn.***REMOVED***ly( this, arguments );
		***REMOVED***;
...
jQuery.event = ***REMOVED***
		...
		if ( !( eventHandle = elemData.handle ) ) ***REMOVED***
			eventHandle = elemData.handle = function( e ) ***REMOVED***
				...
				return typeof jQuery !== "undefined" && jQuery.event.triggered !== e.type ?
					jQuery.event.dispatch.***REMOVED***ly( elem, arguments ) : undefined;
			***REMOVED***;
		***REMOVED***
	...
	***REMOVED***,
	...
	remove: function( elem, types, handler, selector, m***REMOVED***edTypes ) ***REMOVED***
		...
		while ( t-- ) ***REMOVED***
			...
			***REMOVED***
			...
			while ( j-- ) ***REMOVED***
				...
				if ( ( m***REMOVED***edTypes || origType === handleObj.origType ) &&
	...
	***REMOVED***,
	...
	dispatch: function( nativeEvent ) ***REMOVED***
		...
		***REMOVED***
		...
		// Call the preDispatch hook for the m***REMOVED***ed type, and let it bail if desired
			...
			while ( ( handleObj = matched.handlers[ j++ ] ) &&
				...
				if ( !event.rnamespace || handleObj.namespace === false ||
					...
					ret = ( ( jQuery.event.special[ handleObj.origType ] || ***REMOVED******REMOVED*** ).handle ||
						handleObj.handler ).***REMOVED***ly( matched.elem, args );
		...
		***REMOVED***
		...
		// Call the postDispatch hook for the m***REMOVED***ed type
	...
	jQuery.event.add( el, type, ***REMOVED***
		...
		handler: function( event ) ***REMOVED***
			...
			if ( ( event.isTrigger & 1 ) && this[ type ] ) ***REMOVED***
				...
				// native event and prevent that from h***REMOVED***ening again here.
	...
	jQuery.event.special[ orig ] = ***REMOVED***
		...
		handle: function( event ) ***REMOVED***
			...
			if ( !related || ( related !== target && !jQuery.contains( target, related ) ) ) ***REMOVED***
				...
				ret = handleObj.handler.***REMOVED***ly( this, arguments );
				event.type = fix;
			***REMOVED***
			return ret;
		***REMOVED***
...
***REMOVED***, function( name, original ) ***REMOVED***
	jQuery.fn[ name ] = function( selector ) ***REMOVED***
		...
		for ( ; i <= last; i++ ) ***REMOVED***
			...
			// Support: Android <=4.0 only, PhantomJS 1 only
			// .get() because push.***REMOVED***ly(_, arraylike) throws on ancient WebKit
			push.***REMOVED***ly( ret, elems.get() );
		***REMOVED***
	...
	function computeStyleTests() ***REMOVED***
		...
		***REMOVED***
		...
		div.style.cssText =
			...
			"width:60%;top:1%";
		documentElement.***REMOVED***endChild( container ).***REMOVED***endChild( div );
		...
		***REMOVED***,
		...
		reliableTrDimensions: function() ***REMOVED***
			...
			if ( reliableTrDimensionsVal == null ) ***REMOVED***
				...
				documentElement
					.***REMOVED***endChild( table )
					.***REMOVED***endChild( tr )
					.***REMOVED***endChild( trChild );
	...
	return ***REMOVED***
		get: function() ***REMOVED***
			...
			***REMOVED***
			...
			return ( this.get = hookFn ).***REMOVED***ly( this, arguments );
		***REMOVED***
	***REMOVED***;
***REMOVED***
...
// Return a potentially-m***REMOVED***ed jQuery.cssProps or vendor prefixed property
...
var
	...
	// Sw***REMOVED***able if display is none or starts with table
...
function getWidthOrHeight( elem, dimension, extra ) ***REMOVED***
	...
	// Support: Firefox <=54
	// Return a confounding non-pixel value or feign ignorance, as ***REMOVED***ropriate.
	...
	***REMOVED***
	...
	if ( ( !support.boxSizingReliable() && isBorderBox ||
		...
		// This h***REMOVED***ens for inline elements with no explicit setting (gh-3571)
		val === "auto" ||
		...
		// Where available, offsetWidth/offsetHeight ***REMOVED***roximate border box dimensions.
		...
		***REMOVED***
		...
		if ( value !== undefined ) ***REMOVED***
			...
			***REMOVED***
			...
			// The isCustomProp check can be removed in jQuery 4.0 when we only auto-***REMOVED***end
...
// Support: IE <=9 only
// Panic based ***REMOVED***roach to setting things on disconnected nodes
...
jQuery.each( [ "toggle", "show", "hide" ], function( _i, name ) ***REMOVED***
	...
	jQuery.fn[ name ] = function( speed, easing, callback ) ***REMOVED***
		return speed == null || typeof speed === "boolean" ?
			cssFn.***REMOVED***ly( this, arguments ) :
...
( function() ***REMOVED***
	var input = document.createElement( "input" ),
		...
		opt = select.***REMOVED***endChild( document.createElement( "option" ) );
...
jQuery.extend( jQuery.event, ***REMOVED***
	...
	trigger: function( event, data, elem, onlyHandlers ) ***REMOVED***
		...
		***REMOVED***
		...
		special = jQuery.event.special[ type ] || ***REMOVED******REMOVED***;
		if ( !onlyHandlers && special.trigger && special.trigger.***REMOVED***ly( elem, data ) === false ) ***REMOVED***
			return;
		***REMOVED***
		...
		***REMOVED***
		...
		while ( ( cur = eventPath[ i++ ] ) && !event.isPropagationStopped() ) ***REMOVED***
			...
			if ( handle ) ***REMOVED***
				handle.***REMOVED***ly( cur, data );
			***REMOVED***

			// Native handler
			handle = ontype && cur[ ontype ];
			if ( handle && handle.***REMOVED***ly && acceptData( cur ) ) ***REMOVED***
				event.result = handle.***REMOVED***ly( cur, data );
		...
		***REMOVED***
		...
		if ( !onlyHandlers && !event.isDefaultPrevented() ) ***REMOVED***
			...
			if ( ( !special._default ||
				special._default.***REMOVED***ly( eventPath.pop(), data ) === false ) &&
...
var
	...
	rlocalProtocol = /^(?:about|***REMOVED***|***REMOVED***-storage|.+-extension|file|res|widget):$/,
	rnoContent = /^(?:GET|HEAD)$/,
	rprotocol = /^\/\//,
	...
	// Avoid comment-prolog char sequence (#10098); must ***REMOVED***ease lint and evade compression
	allTypes = "*/".concat( "*" ),
...
jQuery.extend( ***REMOVED***
	...
	ajaxSettings: ***REMOVED***
		...
		processData: true,
		async: true,
		contentType: "***REMOVED***lication/x-www-form-urlencoded; charset=UTF-8",
		...
		*/
		...
		accepts: ***REMOVED***
			...
			text: "text/plain",
			html: "text/html",
			xml: "***REMOVED***lication/xml, text/xml",
			json: "***REMOVED***lication/json, text/javascript"
		***REMOVED***,
	...
	ajax: function( url, options ) ***REMOVED***
				...
				statusCode: function( map ) ***REMOVED***
					...
					if ( map ) ***REMOVED***
						if ( completed ) ***REMOVED***
							...
							// Execute the ***REMOVED***ropriate callbacks
		...
		***REMOVED***
		...
		if ( !s.hasContent ) ***REMOVED***
			...
			// If data is available and should be processed, ***REMOVED***end data to url
			if ( s.data && ( s.processData || typeof s.data === "string" ) ) ***REMOVED***
				cacheURL += ( rquery.test( cacheURL ) ? "&" : "?" ) + s.data;

				// #9682: remove data so that it's not used in an eventual re***REMOVED***
				delete s.data;
			***REMOVED***
		...
		***REMOVED*** else if ( s.data && s.processData &&
			( s.contentType || "" ).indexOf( "***REMOVED***lication/x-www-form-urlencoded" ) === 0 ) ***REMOVED***
...
jQuery.ajaxSetup( ***REMOVED***
	accepts: ***REMOVED***
		script: "text/javascript, ***REMOVED***lication/javascript, " +
			"***REMOVED***lication/ecmascript, ***REMOVED***lication/x-ecmascript"
	***REMOVED***,
	contents: ***REMOVED***
	...
	if ( s.crossDomain || s.scriptAttrs ) ***REMOVED***
		...
		return ***REMOVED***
			send: function( _, complete ) ***REMOVED***
				...
				document.head.***REMOVED***endChild( script[ 0 ] );
			***REMOVED***,
			abort: function() ***REMOVED***
				if ( callback ) ***REMOVED***
					callback();
	...
	var callbackName, overwritten, responseContainer,
		jsonProp = s.jsonp !== false && ( rjsonp.test( s.url ) ?
			...
			typeof s.data === "string" &&
				( s.contentType || "" )
					.indexOf( "***REMOVED***lication/x-www-form-urlencoded" ) === 0 &&
	...
	***REMOVED***
	...
	if ( !context ) ***REMOVED***
		...
		if ( support.createHTMLDocument ) ***REMOVED***
			...
			context.head.***REMOVED***endChild( base );
		***REMOVED*** else ***REMOVED***
			context = document;
		***REMOVED***
	***REMOVED***
	...
	if ( self.length > 0 ) ***REMOVED***
		...
		***REMOVED*** ).done( function( responseText ) ***REMOVED***
			...
			self.html( selector ?
				...
				jQuery( "<div>" ).***REMOVED***end( jQuery.parseHTML( responseText ) ).find( selector ) :
		...
		***REMOVED*** ).always( callback && function( jqXHR, status ) ***REMOVED***
			self.each( function() ***REMOVED***
				callback.***REMOVED***ly( this, response || [ jqXHR.responseText, status, jqXHR ] );
			***REMOVED*** );
		***REMOVED*** );
	***REMOVED***
...
// Bind a function to a context, optionally partially ***REMOVED***lying any
// arguments.
...
jQuery.proxy = function( fn, context ) ***REMOVED***
	...
	***REMOVED***
	...
	proxy = function() ***REMOVED***
		return fn.***REMOVED***ly( context || this, args.concat( slice.call( arguments ) ) );
	***REMOVED***;
